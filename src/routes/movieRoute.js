...
router.patch('/:movieId', permissionsMiddleware(SECTION.MOVIE, ACTION.UPDATE), movieControllers.partialMovieUpdate)
router.delete('/:movieId', permissionsMiddleware(SECTION.MOVIE, ACTION.DELETE), movieControllers.deleteMovie)
